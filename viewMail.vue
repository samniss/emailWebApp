<template>
  <div id="compose-pane">
    <div id="compose-boxes">
      ...
      <receivers-views id="enterEmail" v-on:addReceiver="setReceivers" v-bind:receivers="receivers"/>
      <input id="subject" v-model="subject" placeholder="Subject:" readonly/>
      <textarea
        id="content"
        v-model="content"
        ...
        readonly
      ></textarea>
      <files-view v-on:addFiles="setFiles" v-bind:date="date" v-bind:from="from" v-bind:fileNames="fileNames"/>
    </div>
  </div>
</template>
<script>
